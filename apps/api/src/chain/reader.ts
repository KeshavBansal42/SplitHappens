/**
 * On-chain escrow reader. Polls the frozen getSplitStatus view; no events
 * are involved (the interface deliberately has none), so this is the
 * source of truth the watchers and the status endpoint share.
 */
