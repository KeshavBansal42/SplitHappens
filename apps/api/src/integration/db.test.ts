/**
 * Repository/service integration tests against a real Postgres.
 *
 * These intentionally do NOT mock ../db.js — they exercise the actual
 * prisma client, the Decimal/BigInt columns, and the joinSplit/paySplit
 * service transactions end to end. They expect a reachable database at
 * DATABASE_URL (setupEnv points at splitstream_test with migrations
 * applied) and truncate the tables before each test.
 */
